...
public final class GameSettings {
	 ...
	 */
	GameSettings(String name, boolean beta, boolean devMode, boolean gui, GameType type, int worldId, int countryIndex, String activity, boolean members, boolean pvp, boolean quickChat, boolean lootshare, String msAddress) {
		this.name = name;
		this.beta = beta;
	...
	public static GameSettings parse(String[] args) {
		...
		return new GameSettings(name, beta, devMode, gui, type, worldId, country, activity, members, pvp, quickChat, lootshare, msAddress);
	}
